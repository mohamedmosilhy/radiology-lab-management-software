...
const navigationLinks = [
  ...
  },
  {
    ...
    name: "Subjects",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24"
           stroke="currentColor">
      ...
      <div className="flex flex-col justify-between flex-1 mt-14">
        ...
        <a href="#" className="flex items-center px-4 -mx-2">
          <div className="flex flex-col">
            <span className="mx-2 font-medium text-gray-800 dark:text-gray-200">Dr. {currDoctor["name"]}</span>
            <span className="mx-2 text-xs text-gray-500 dark:text-gray-200">{currDoctor["specialization"]}</span>
          </div>
        </a>
      </div>
    </aside>
